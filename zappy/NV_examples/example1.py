...
class Example(Group):
    ...
    def setup(self):
        ...
        par.add_output('I_in', 10.0, units='A')
        par.add_output('R_1', 10.0, units='ohm')
        par.add_output('R_2', 5.0, units='ohm')
        par.add_output('R_3', 10.0, units='ohm')
        par.add_output('R_4', 5.0, units='ohm')
        par.add_output('R_5', 20.0, units='ohm')

        self.add_subsystem('N1', Node(connect_names=['c0', 'c2', 'c3']), promotes=[('V', 'V_1')])
        ...
        self.add_subsystem('R1', Resistor(), promotes=[('R', 'R_1'), ('V_in', 'V_0'), ('V_out', 'V_1')])
        ...
        self.add_subsystem('R4', Resistor(), promotes=[('R', 'R_4'), ('V_in', 'V_0'), ('V_out', 'V_3')])
        self.add_subsystem('R5', Resistor(), promotes=[('R', 'R_5'), ('V_in', 'V_1'), ('V_out', 'V_3')])

        self.connect('R1.I_out', 'N1.c0:I')
        self.connect('R2.I_in', 'N1.c2:I')
        self.connect('R2.I_out', 'N2.c1:I')
        self.connect('R3.I_in', 'N2.c3:I')
        self.connect('R3.I_out', 'N3.c2:I')
        self.connect('R4.I_out', 'N3.c0:I')
        self.connect('R5.I_in', 'N1.c3:I')
        self.connect('R5.I_out', 'N3.c1:I')
        self.connect('I_in', 'N2.c0:I')
